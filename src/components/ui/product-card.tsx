...
export function ProductCard({ product, view = 'grid' }: ProductCardProps) {
  ...
  if (view === 'list') {
    return (
      <motion.div
        layout
        className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl overflow-hidden hover:border-accent-blue/50 transition-all duration-300"
      >
  ...
  return (
    <motion.div
      layout
      className="group bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl overflow-hidden hover:border-accent-blue/50 transition-all duration-300"
    >
